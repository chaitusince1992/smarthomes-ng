...
export class ApplianceListComponent implements OnInit, OnChanges {
  ...
  mouseoverOnAppl(e:any, isClicked:any) {
    if (isClicked)
      d3.selectAll("g.each-area")
        .transition()
        .duration(250)
        .attr("fill-opacity", (a:any, b:any, c: any) => {
  ...
  mouseleaveOnAppl(e:any, isClicked:any) {
    if (isClicked)
      d3.selectAll("g.each-area")
        .transition()
        .duration(250)
  ...
  clickedOnAppl(e:any, data:any) {
    ...
    var itr = 0;
    this.applianceList.forEach((d:any) => {
      if (d.clicked === true) {
  ...
  getApplianceList() {
    ...
    this.apiService.callServicePost('getApplianceList', {
    ...
    }, (houseData:any) => { //get the appliance list
      ...
      ********/
      ...
      this.clickedAppliancesCSV = '';
      var itr = 0;
      houseData.forEach((d:any, i:number) => {
