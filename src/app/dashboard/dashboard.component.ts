...
export class DashboardComponent implements OnInit {
  ...
  applianceList: any;
  clickedAppliancesArray: any;
  clickedAppliancesCSV: any;

  clickedApplianceId: any;
  ...
  noHomeSelected: boolean = false;
  selectedHome: any;
  // chartDataArray = [];
  ngOnInit() {

    this.apiService.callServicePost('getHomesList', undefined, (data: any) => {
      // console.log(data);
      this.homesList = data;
      ...
      ************/
      ...
      this.homesList.forEach((d:any, i:number) => {
        d.clicked = false;
      ...
      ************/
      ...
      this.apiService.callServiceGet("minAndMax?houseId=" + this.clickedHomesCSV, (res: any) => {
        // console.log(res);
        this.sliderData = {
  ...
  applianceSelected(applData: any) {
  ...
  *************/
  consumptionDetails() {
    this.apiService.callServicePost("allApplHomesSummary", {
      ...
      this.applianceList.forEach((d: any, i: number) => {
  ...
  clickedOnHome(e: any, houseData: any, index: number) {
    // console.log(e, houseData);
    this.selectedHome = houseData;
    houseData.clicked = !houseData.clicked;
    let el: any = document.getElementsByClassName("each-home select-all");
    el[0]["dataset"].selectState = "some";
    this.clickedHomesCSV = '';
  ...
  timeSliderChanged(sliderData:any) {
    this.sliderData = sliderData;
    // this.sliderData = {...sliderData}; // to detect changes
  }

  aggregatedChart(e:any) {
